...
<body>
	...
	<div class="login_con">
		<div class="login_con_L">
			<img src="images/background/login_img.png" />
		</div>
		<div class="login_con_R">
			...
			<FORM id="loginFormId" class="form-horizontal" action="login" method="post">
				<div class="form-group input-group">
                    ...
                    <input type="text" class="form-control" placeholder="用户名"  name="username" id="j_username" value="admin">
				</div>
                <div class="form-group input-group">
	    ...
	    var dologin = function() {
        	...
        	$.ajax({
        		...
        		success: function(data){
        			if(data.success){
        				$('.login_con_R').message({type: 'success',  content:  '登录成功！'});
