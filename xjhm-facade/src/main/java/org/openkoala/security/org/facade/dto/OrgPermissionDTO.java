...
/**
 * Created by luzhao on 14-9-24.
 */
public class OrgPermissionDTO extends PermissionDTO {

    //与组织机构集成需要
    private String employeeUserOrgName;

    public OrgPermissionDTO() {
    }

    public OrgPermissionDTO(Long id, String name, String identifier, String description) {
        super(id, name, identifier, description);
    }
